export class CanvasLocal {
     ...
     */
        ...
        for (let i = 0.5; i <= 8; i += 2 * avance) {
            ...
            this.drawBarra3d(this.iX(i), this.iY(0), this.iX(i), this.iY(6 * h[ind] / maxEsc - 0.1), this.iX(i + 0.5), this.iY((6 * h[ind] / maxEsc - 0.1) + 0.25), this.iX(i + avance + 0.5), this.iY((6 * h[ind] / maxEsc - 0.1) + 0.25), this.iX(i + avance + 0.5), this.iY(0.25), this.iX(i + avance), this.iY(0), colors[ind % colors.length]);
            this.graphics.strokeStyle = 'black';
